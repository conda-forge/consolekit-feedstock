...
Once the `conda-forge` channel has been enabled, `consolekit` can be installed with:

```
conda install consolekit
```

It is possible to list all of the versions of `consolekit` available on your platform with:
